...
::: {.column width="50%"}
![](images_malaria/erythrocyteeffect.jpeg){fig-align="center" width="800"}
:::
:::::
...
::: {.column width="50%"}
![](images_malaria/hyponozoites.png)
:::
:::::
...
-   Time to severe malaria: can be **hours P. falciparum**
