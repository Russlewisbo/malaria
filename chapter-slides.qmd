...
format:
  revealjs:
    ...
    height: 720
    margin: 0.08
    footer: "Malaria — Parikh & Taylor | PPID 9th ed."
...
### Italy (2017): The Sofia Case
- 4-year-old girl in Trento — no travel history
- Contracted *P. falciparum* in hospital where 2 African children being treated for malaria
- "It's the first time in my 30-year career that I've seen a case of malaria originating in Trentino"
:::
::: {.column width="50%"}
### Imported Malaria in the US
- **~2,000 cases/year** (pre-pandemic); ~1,500 in 2020
- **88%** from sub-Saharan Africa; 8% Asia
- **75% are VFR travelers** (visiting friends and relatives)
- VFR travelers: less likely to seek pre-travel advice, less likely to take chemoprophylaxis, may have false sense of immunity
...
## Naturally Acquired Immunity ("Premunition") {.center}
...
## Host Genetic Factors: Malaria's Evolutionary Legacy {.center}
...
::: {.callout-note}
Malaria has shaped more human genetic diversity than any other infectious disease — a fact that links evolutionary biology directly to bedside medicine.
:::
:::
:::
...
## Complications of Severe *P. falciparum* Malaria {.center}
...
::: {.column width="50%"}
### Metabolic/Renal
- **Metabolic acidosis**: Best predictor of mortality (lactate ≥5 mmol/L)
...
::: {.notes}
Walk through each complication with the pathophysiology. Key teaching points: (1) Metabolic acidosis is the single best predictor of death — better than parasitemia. (2) Hypoglycemia is rapidly reversible but commonly missed — always check glucose on admission. (3) Pulmonary edema can worsen paradoxically AFTER treatment starts — be cautious with IV fluids. (4) Bacterial co-infection is common enough that empiric antibiotics should be started in shocked patients.
:::
...
::: {.notes}
Pregnancy-associated malaria is a major cause of maternal and neonatal morbidity in sub-Saharan Africa. In 2022, 36% of pregnancies in 33 moderate-high transmission African countries were exposed to malaria. The VAR2CSA story is elegant — it explains why first pregnancies are most affected and why protection develops with parity. IPTp-SP is one of the most cost-effective interventions in global health.
:::
...
## Differential Diagnosis of Malaria {.smaller .center}
...
::: {.notes}
This is a critical teaching slide. Malaria should always be at the top of the differential for fever + travel to endemic area. But remind students that identifying malaria does NOT rule out other diagnoses — bacterial co-infection is present in 5–8% of severe malaria cases, and empiric antibiotics should be started in any patient with shock. Dengue and malaria co-infection is increasingly recognized in SE Asia and South America.
:::

---

## Monitoring Treatment Response {.center}
...
## Severe Malaria: ICU Management Pearls {.smaller}
...
::: {.notes}
Pre-travel counseling is one of the most practical aspects of malaria medicine for US clinicians. The VFR (visiting friends and relatives) traveler is particularly high risk — they often don't seek pre-travel advice, assume residual immunity, and may stay in higher-risk rural areas. Atovaquone-proguanil has become the most popular choice for US travelers because of its short tail (only 7 days post-travel) and good tolerability. Doxycycline is underused but is the most cost-effective option for long-term travelers. Mefloquine has fallen out of favor due to neuropsychiatric side effects, but it remains an important option for pregnant women in the 2nd/3rd trimester and for those who need a weekly regimen.
:::
...
::: {.notes}
The chloroquine story is one of the great cautionary tales in infectious diseases. The global spread of CQ resistance caused a massive increase in malaria mortality in Africa in the 1980s-1990s. The recovery of CQ sensitivity after its withdrawal is scientifically fascinating and has practical implications: it suggests that strategic drug rotation could be feasible. The concern is whether artemisinin-resistant parasites will follow the same fitness-cost pattern, or whether compensatory mutations will allow them to maintain resistance without fitness penalty. Triple ACTs (adding a third partner drug) are being tested in clinical trials to try to overwhelm resistance mechanisms.
:::
...
::: {.notes}
The choice of ACT varies by region based on resistance patterns. In the US, artemether-lumefantrine (Coartem) is the only FDA-approved ACT, which simplifies our decision-making. For severe malaria, IV artesunate is FDA-approved and should be used regardless of geographic origin. The WHO recommends that countries change first-line ACT when treatment failure rates exceed 10% at day 28 follow-up.
:::
...
## Non-Falciparum Malaria: Unique Challenges {.smaller}
...
::: {.notes}
The malaria elimination landscape is a story of contrasts. On one hand, more countries than ever are achieving zero cases and certification. On the other, the 11 highest-burden countries (mostly in West and Central Africa) still account for ~70% of global cases, and progress there has stalled or reversed. China's certification in 2021 was remarkable — from 30 million cases annually in the 1940s to zero by 2017 through a combination of surveillance (the 1-3-7 strategy), treatment, and vector control. The funding gap remains the single biggest obstacle. The WHO estimates that an additional $3-4 billion per year is needed beyond current investments to get back on track toward the 2030 targets.
:::
...
## When to Call the CDC Malaria Hotline {.center}
...
::: {.notes}
The CDC Malaria Hotline is one of the most underutilized resources in US infectious diseases. Every resident should have this number saved in their phone. The parasitologists on call can help with species identification, treatment recommendations, artesunate access, and complex management decisions. The DPDx telediagnosis service is particularly useful for community hospitals without tropical medicine expertise.
:::

---

## Audience Participation: Test Your Knowledge {.center}

::: {.incremental}
1. **A 4-year-old child from Nigeria presents with fever, seizures, and parasitemia of 15%. What is the FIRST drug to administer?**
   - IV artesunate 3 mg/kg (higher dose for children <20 kg per WHO)

2. **A Peace Corps volunteer returns from PNG with *P. vivax* malaria. Before starting primaquine, what test is mandatory?**
   - G6PD testing (quantitative preferred if considering tafenoquine)

3. **Name 3 WHO criteria for severe malaria.**
...
4. **A negative RDT in a febrile traveler from Eritrea — can you safely rule out malaria?**
   - NO: PfHRP2 gene deletions are prevalent in Eritrea → false-negative HRP2-based RDTs. Must confirm with microscopy or PCR.
:::

::: {.notes}
Use these as audience engagement questions — pause after each question before revealing the answer. These reinforce the highest-yield clinical points from the lecture.
:::
