...
date: "01-04-2025"
>>>>>>> fe9bd34432a27f76a80d82fea472bd9b842135d0
format:
  revealjs:
    theme: [custom.scss]
    slide-number: true
...
::: callout-important
**2023**: First local transmission clusters in 20 years - Florida (7 *P. vivax*), Texas, Arkansas, Maryland - Vector: *Anopheles crucians* in Florida
:::
...
**Cytoadherence system:** - Infected RBCs express **PfEMP-1** (var genes, \~60 variants) - PfEMP-1 binds endothelium via CD36, ICAM-1, EPCR, CSA - Results in **microvascular obstruction**

**Rosetting:** - iRBCs bind uninfected RBCs → clusters obstruct capillaries
...
✅ Species ID + quantification ✅ Available worldwide ✅ Stage identification ❌ Requires expertise ❌ Labor-intensive ❌ At least 200 fields for negative
...
✅ Rapid result (15 min) ✅ No microscopy expertise needed ✅ P. falciparum: sensitivity 94.8% ❌ No quantification ❌ False negatives: **HRP2 deletions** ❌ Cannot monitor treatment
...
✅ Highest sensitivity ✅ Species + quantification ✅ Drug resistance testing ❌ Available only in reference labs ❌ Slow turnaround (not for acute Dx) ❌ Expensive
