...
![](images_malaria/fig280-3_anopheles.png){fig-align="center" width="800"}
...
![](images_malaria/RDT.png){fig-align="center"}
...
|------------------------|------------------------|------------------------|
| **Viral** | Influenza, dengue, chikungunya, Zika, yellow fever, COVID-19, VHF, viral meningitis | Dengue: more severe myalgia/arthralgia, rash, shorter incubation (4–7 d); <br> Yellow fever: biphasic, relative bradycardia; COVID: anosmia, respiratory Sx |
...
```{=html}
<figure style="font-family: sans-serif; font-size: 0.72em; max-width: 560px; margin: auto;">
<style>
  .flow-box { border: 2px solid #2c7bb6; border-radius: 5px; padding: 4px 10px; background: #eaf4fb; text-align: center; display: inline-block; }
  ...
  .arrow  { text-align: center; color: #555; font-size: 1em; line-height: 1; margin: 1px 0; }
  .flow-col { display: flex; flex-direction: column; align-items: center; gap: 2px; flex: 1; }
  .flabel { font-size: 0.82em; font-weight: bold; color: #555; }
</style>
<div style="display:flex; flex-direction:column; align-items:center; gap:2px;">
  ...
  <div class="arrow">&#8595;</div>
  <div style="display:flex; width:90%; justify-content:space-around; align-items:flex-start; margin-top:2px;">
    <div class="flow-col">
    ...
    <div class="flow-col">
      ...
      <div style="display:flex; width:100%; justify-content:space-around; align-items:flex-start; margin-top:2px;">
        <div class="flow-col">
          ...
          <div style="margin-top:4px;" class="flow-box decision">Chloroquine-sensitive area?</div>
          <div class="arrow">&#8595;</div>
...
<figcaption style="text-align:center; margin-top:8px; color:#555; font-size:0.8em;">Figure: Simplified malaria treatment algorithm. ACT&#160;= artemisinin-based combination therapy.</figcaption>
</figure>
```
...
## Anti-relapse treatment: The radical cure {.center}
...
::: aside
The FEAST trial was a landmark study that changed fluid management in African children with severe infections — it showed a 3.3% absolute increase in mortality with fluid bolus therapy. This challenged decades of practice and applies to severe malaria.
:::
...
# Additional slides {background-color="#9B0014"}
