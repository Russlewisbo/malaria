---
title: "Chapter 280: Malaria (*Plasmodium* Species)"
subtitle: "Mandell, Douglas, and Bennett's Principles and Practice of Infectious Diseases, 9th ed."
author:
  - name: Sunil Parikh
...
Indigenous malaria was eliminated in the US by the mid-20th century. Malaria is now a **disease of travelers and immigrants**: the CDC received reports of 1,823 confirmed malaria cases in 2018, approximately 88% imported from Africa. *P. falciparum* accounts for ~80% of US cases; *P. vivax* ~10%.

::: {.callout-important}
## 2023 Alert: First Local Transmission in 20 Years
In 2023, the first clusters of locally acquired malaria since 2003 were reported in four US states: 7 cases in Florida (*P. vivax*, vector *A. crucians*, 3 affected individuals experiencing homelessness), 1 in Texas, 1 in Arkansas (*P. vivax*), and 1 *P. falciparum* case in Maryland. All travelers to endemic areas within the previous 3 months should be considered to have malaria until proven otherwise.
:::
...
: TABLE 280.1. Severe malaria criteria: one or more of the following, in the absence of an identified alternative cause and in the presence of asexual malaria parasitemia. Adapted from WHO Guidelines for Malaria, October 2023 [@WHO2023Guidelines]. {#tbl-treatment}
...
: TABLE 280.2a. Key light microscopy features for speciation of human malaria parasites. {#tbl-labdiagnosis}
...
**Important limitation**: The CDC provides free malaria PCR speciation and drug resistance testing for US clinicians; however, results typically take 1–3 days and should **never** delay initiation of treatment [@PCRMalariaDiagnosis].
...
- **CDC Malaria Hotline**: 770-488-7788 (Mon–Fri, 9 a.m.–5 p.m. ET); 770-488-7100 (after hours)
- **CDC Treatment Guidelines**: [https://www.cdc.gov/malaria/hcp/clinical-guidance/general-treatment.html](https://www.cdc.gov/malaria/hcp/clinical-guidance/general-treatment.html)
...
In the United States, **only artemether-lumefantrine (Coartem)** is FDA-approved. WHO-recommended ACTs include six regimens, all administered over 3 days:

### TABLE 280.4a — Artemether-Lumefantrine (AL, Coartem): Complete Weight-Based Dosing {#tbl-coartem}
...
### TABLE 280.4b — All WHO-Recommended ACTs: Drug Doses and Key Points {#tbl-allacts}
...
: TABLE 280.4. Recommended treatment regimens for uncomplicated malaria. Artesunate component across all ACTs is uniformly dosed at 4 mg/kg/day for 3 days. All ACTs achieve PCR-adjusted cure rates >95% in areas without partner-drug resistance [@CDC2023MalariaTreatment; @WHO2023Guidelines]. {#tbl-treatment}
...
**In the United States**: IV artesunate is commercially available. If not in stock or available within 24 hours, contact the CDC Malaria Hotline (770-488-7788).
...
Malaria can largely be prevented in travelers to endemic areas when recommended regimens are prescribed and taken appropriately. In 2018, 95% of US-based travelers with malaria did not adhere to or did not take a CDC-recommended prophylaxis regimen [@CDC2023MalariaTreatment].

Key regimen selection factors:
- Geographic drug-resistance epidemiology
- Patient age, comorbidities, drug–drug interactions
- Pregnancy status
- Compliance factors: dosing interval, duration, cost, tolerability
...
- **WHO Guidelines for Malaria (2023)**: [https://www.who.int/publications/i/item/guidelines-for-malaria](https://www.who.int/publications/i/item/guidelines-for-malaria)
- **CDC Malaria Treatment Guidelines**: [https://www.cdc.gov/malaria/hcp/clinical-guidance/general-treatment.html](https://www.cdc.gov/malaria/hcp/clinical-guidance/general-treatment.html)
- **CDC Yellow Book 2024**: [https://wwwnc.cdc.gov/travel/yellowbook/2024/infections-diseases/malaria](https://wwwnc.cdc.gov/travel/yellowbook/2024/infections-diseases/malaria)
- **CDC Malaria Hotline**: 770-488-7788 (Mon–Fri 9 am–5 pm ET); 770-488-7100 (after hours)
- **Malaria Atlas Project**: [https://malariaatlas.org/](https://malariaatlas.org/)
- **CDC DPDx (Parasitologic Diagnosis)**: [https://www.cdc.gov/dpdx/malaria/index.html](https://www.cdc.gov/dpdx/malaria/index.html)
